...
public class TagHelper {
   ...
   */
  public static Map<String, String> convertToMap(final Collection<software.amazon.qbusiness.plugin.Tag> tags) {
    ...
    return tags.stream()
        ...
        .collect(Collectors.toMap(
            software.amazon.qbusiness.plugin.Tag::getKey,
            software.amazon.qbusiness.plugin.Tag::getValue,
